...
INSERT INTO categories(cate_name,cate_description,cate_img)VALUES('Arts and Literature','Explore a diverse array of topics, from iconic literary works and famous artists to artistic movements and literary genres, as you navigate through our engaging quizzes. From classic literature to modern masterpieces, and from Renaissance art to contemporary creations, our questions are designed to inspire curiosity and spark imagination.','photos/img_148719_replicability.jpg');

INSERT INTO categories(cate_name,cate_description,cate_img)VALUES('Tourism and management','Are you ready to explore the exciting and dynamic world of tourism and management? Whether you''re an aspiring professional in the hospitality industry, a seasoned tourism expert, or simply someone with a passion for travel and hospitality, our quizzes offer an engaging opportunity to test your knowledge and expertise in this vibrant field.','photos/businessss.jpg');
